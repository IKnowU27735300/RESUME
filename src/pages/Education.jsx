      ...
      <div className="flex flex-col gap-6 md:gap-8 w-full max-w-2xl relative z-10">
        {eduData.map((edu, idx) => (
          <motion.div
            ...
            className="glass p-6 md:p-10 rounded-3xl relative cursor-pointer group hover:bg-black/5 border border-black/10 transition-all duration-500 shadow-xl"
          >
            ...
            <h3 className="text-2xl md:text-3xl font-display font-black text-gray-900 mb-2 leading-tight">
              {edu.role}
            </h3>
            ...
            {edu.desc && (
              <p className="text-sm md:text-base text-gray-600 leading-relaxed font-sans group-hover:text-gray-800 transition-colors">
                {edu.desc}
              </p>
            )}
            ...
            <AnimatePresence>
              {hoveredIdx === idx && (
                <motion.div
                  ...
                  className="absolute bottom-full left-1/2 -translate-x-1/2 md:-translate-x-0 md:left-full md:bottom-auto md:top-0 md:ml-8 mb-4 md:mb-0 w-[280px] glass rounded-2xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.1)] z-[100] pointer-events-none border border-black/10 backdrop-blur-3xl"
                >
                  ...
                  <div className="p-5 bg-white/90">
                    <strong className="block text-gray-900 text-base mb-2 font-display">{edu.review.title}</strong>
                    ...
                    <p className="text-gray-600 text-xs leading-relaxed mb-1">{edu.review.desc}</p>
                  </div>
                </motion.div>
              )}
            </AnimatePresence>
